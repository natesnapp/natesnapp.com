<template>
  <div>
    <div class="btn-group btn-group-justified form-group social-links visible-xs visible-sm" role="group">
      <a href="https://twitter.com/snappaction" target="_blank" class="btn fa fa-twitter"></a>
      <a href="https://github.com/natesnapp" target="_blank" class="btn fa fa-github-alt"></a>
      <a href="https://www.linkedin.com/in/natesnapp" target="_blank" class="btn fa fa-linkedin"></a>
    </div>
